!function(e) {
    if ("object" == typeof exports)module.exports = e();
        ...
        var f;
        "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.EntityService = e()
    }
}(function() {
...
// shim for using process in browser
        ...
        7: [
            function(_dereq_, module, exports) {
                ...
                exports.Query = Query;
                exports.Item = Item;
            }, { "./config.json": 6, "./item": 8, "emitter-component": 2, "q": 4, "sc-extendify": 10, "sc-hasKey": 12, "sc-is": 16, "sc-merge": 22, "sc-optionify": 25, "sc-query": 28 }
        ],
        8: [
            function(_dereq_, module, exports) {
                var is = _dereq_("sc-is"),
                ...
                module.exports = Item;
            }, { "emitter-component": 2, "q": 4, "sc-extendify": 10, "sc-hasKey": 12, "sc-is": 16, "sc-omit": 24, "sc-optionify": 25, "sc-pick": 26 }
        ],
        9: [
            function(_dereq_, module, exports) {
	 ...
	 */
        ...
        10: [
            ...
            }, { "./extend.johnresig.js": 9, "sc-haskey": 14, "sc-merge": 22, "sc-omit": 24 }
        ],
        11: [
            function(_dereq_, module, exports) {
 ...
 */
        ...
        16: [
            function(_dereq_, module, exports) {
                ...
                exports.type = type;
            }, { "./ises/empty": 17, "./ises/guid": 18, "./ises/nullorundefined": 19, "./ises/type": 20 }
        ],
        17: [
            function(_dereq_, module, exports) {
 ...
 */
            ...
            }, { "./config.json": 27, "./utils": 29, "q": 4, "sc-extendify": 10 }
        ],
        29: [
            function(_dereq_, module, exports) {
                module.exports = {
            ...
            }, { "sc-is": 16, "sc-merge": 22, "sc-optionify": 25, "sc-request": 31, "sc-useify": 52 }
        ],
        30: [
            function(_dereq_, module, exports) {
                module.exports = {
        ...
        31: [
            ...
            }, { "./config.json": 30, "q": 4, "sc-guid": 11, "sc-haskey": 14, "sc-is": 16, "sc-merge": 22, "sc-queue": 32, "sc-useify": 52, "superagent": 33 }
        ],
        32: [
            function(_dereq_, module, exports) {
/**
 ...
 */
        ...
        41: [
            ...
            }, { "./isEmpty": 42, "sc-wherejs": 38, "type-component": 43 }
        ],
        42: [
            function(_dereq_, module, exports) {
 ...
 */
            ...
            }, { "./sanitize": 45, "./utils": 47, "./validate": 49 }
        ],
        45: [
            function(_dereq_, module, exports) {
                var utils = _dereq_("./utils");
 ...
 */
        ...
        47: [
            ...
            }, { "./extend": 46, "./isEmpty": 48, "sc-cast": 36, "sc-guid": 11, "sc-haskey": 14, "type-component": 43 }
        ],
        48: [
            function(_dereq_, module, exports) {
                var isEmpty = function(val) {
 ...
 */
            ...
            }, { "./utils": 63, "q": 4, "sc-bindingjs": 5, "sc-data": 7, "sc-schemajs": 44, "sc-trackable": 50 }
        ],
        55: [
            function(_dereq_, module, exports) {
/**
 ...
 */
            ...
            }, { "./config.json": 53, "./entity": 54, "./middleware": 56, "./sc-query": 60, "./utils": 63, "q": 4, "sc-data": 7, "sc-schemajs": 44 }
        ],
        56: [
            function(_dereq_, module, exports) {
...
// Initialise the custom validators
            ...
            }, { "../config.json": 53, "../utils": 63, "./scQueryPostRequest": 57, "./scQueryPreRequest": 58, "./scRequestPostRequest": 59, "sc-data": 7, "sc-query": 28, "sc-schemajs": 44 }
        ],
        57: [
            function(_dereq_, module, exports) {
                var utils = _dereq_("../utils"),
            ...
            }, { "../entity": 54, "../utils": 63, "sc-schemajs": 44 }
        ],
        58: [
            function(_dereq_, module, exports) {
                var utils = _dereq_("../utils"),
            ...
            }, { "../config.json": 53, "../entity": 54, "../utils": 63, "sc-data": 7, "sc-schemajs": 44 }
        ],
        59: [
            function(_dereq_, module, exports) {
                var utils = _dereq_("../utils");
        ...
        63: [
            ...
            }, { "./getEntitySchemaByType": 61, "./getResponseObject": 62, "./metadata": 65, "./metadataValidator": 64, "./validator": 66, "emitter-component": 2, "sc-guid": 11, "sc-haskey": 14, "sc-is": 16, "sc-merge": 22, "sc-omit": 24, "sc-optionify": 25, "sc-pick": 26, "sc-request": 31, "sc-useify": 52 }
        ],
        64: [
            function(_dereq_, module, exports) {
                var q = _dereq_("Q"),
