    ...
    (function(n) {
        ...
        (function(n) { "function" === typeof define && define.amd ? define(["exports", "require"], n) : "object" === typeof exports && "object" === typeof module ? n(module.exports || exports) : n(x.ko = {}) })(function(N, O) {
            ...
            a.a = function() {
                ...
                b(k, function(a, b) { if (b.length)for (var c = 0, d = b.length; c < d; c++)l[b[c]] = a });
                ...
                return{
                    ...
                    ec: function(b, c) {
                        for (var d = a.a.V(b.getElementsByTagName("input")).concat(a.a.V(b.getElementsByTagName("textarea"))),
                            e = "string" == typeof c ? function(a) { return a.name === c } : function(a) { return c.test(a.name) },
                            h = [],
                            m = d.length - 1; 0 <= m; m--)e(d[m]) && h.push(d[m]);
                        return h
                    },
            ...
            (function() {
                ...
                a.U = function(b, c, d, e) {
                    var h = this, f = "function" == typeof b && !a.H(b), m,
                        g = a.B(function() {
            ...
            (function(b) {
                ...
                function e(c, d, f, h) {
                    ...
                    if (g) {
                        ...
                        if (q) {
                            var p = !1;
                            if (q.apply(g, d.concat(function(a) { p ? f(null) : null !== a ? f(a) : e(c, d, f, h) })) !== b && (p = !0, !g.suppressLoaderExceptions))throw Error("Component loaders must supply values by invoking the callback, not by returning values synchronously.");
                        } else e(c, d, f, h)
                    } else f(null)
                }
            ...
            (function() {
                ...
                a.kd = function(b, d, g, k, q) {
                    ...
                    function u(a, c) {
                        s = q.createChildContext(a, g.as, function(a) { a.$index = c });
                        var d = f(b, a, s);
            ...
            (function() {
                ...
                a.a.Bb = function(e, f, g, k, l) {
                    ...
                    function h(b, c) { if (b)for (var d = 0, e = c.length; d < e; d++)c[d] && a.a.q(c[d].ca, function(a) { b(a, d, c[d].ja) }) }
